...
document.addEventListener("DOMContentLoaded", function() {
    ...
    function ClientRC() {
        console.log('working');
        x.src = "https://snware2.pythonanywhere.com/snware/clientRC";
        x0.style.color="blue"
    ...
    function SupplyRC() {
      console.log("workin");
        x.src = "https://snware2.pythonanywhere.com/snware/supplierRC";
        x1.style.color="blue"
    ...
    function DPquote() {
        x.src = "https://snware2.pythonanywhere.com/snware/DPquote";
        x2.style.color="blue"
        x1.style.color="black"
        x0.style.color="black"
        x3.style.color="black"
    ...
    function SPquote() {
        x.src = "https://snware2.pythonanywhere.com/snware/SPquote";
        x3.style.color="blue"
        x1.style.color="black"
        x2.style.color="black"
        x0.style.color="black"
